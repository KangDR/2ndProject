...
ArrayList<ArticleBean> list=adao.randomData();
...
<div style="text-align: right;"><input type="button" value="수정하기" class="buttons" onclick="location.href='updateArticle.jsp?title=<%=list.get(0).getTitle()%>'"></div>
</div>
